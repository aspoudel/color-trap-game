    ...
    <div>
      ...
      <div className="rule-book">
        <p className="rules-line">
          ...
          position of that colored tile that you turn up. In the next subsequent
          turns, if you happen to roll one of the colors that matches with the
          tiles you have already memorized, select that tile and the point is
          yours. Keep practicing to improve your short term memory skills.
        </p>
        <p className="rules-line">
